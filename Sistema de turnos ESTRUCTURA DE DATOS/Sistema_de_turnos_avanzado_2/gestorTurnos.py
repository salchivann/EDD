...
class GestorTurnos:
    """
    Orquesta todas las estructuras de datos del sistema:

    - Cola               -> atención normal (FIFO)
    - ColaPrioridad       -> atención preferencial
    - Pila                -> historial de turnos atendidos/cancelados (LIFO)
    - ListaEnlazadaDoble  -> registro maestro de todos los turnos generados
    - ArbolBST            -> índice del historial para búsqueda por código
    """
